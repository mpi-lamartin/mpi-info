...
<QCM
  ...
  questions={[
    ...
    },
    {
      ...
      correct: 1,
      explanation: "Bellman-Ford effectue n-1 passes, chacune examinant toutes les p arêtes, soit O(n · p)."
    },
    {
    ...
    },
    {
      ...
      correct: 2,
      explanation: "Floyd-Warshall utilise trois boucles imbriquées sur les n sommets, d'où O(n³)."
    },
    {
