  ...
  questions={[
    {
      ...
      correct: 1,
      explanation: "Dijkstra calcule les plus courts chemins depuis une source unique, mais ne fonctionne qu'avec des poids positifs ou nuls."
    },
    {
      ...
      correct: 0,
      explanation: "Bellman-Ford fonctionne avec des poids négatifs et peut détecter les cycles de poids négatif."
    },
    {
      ...
      correct: 2,
      explanation: "Avec un tas binaire, chaque extraction du minimum coûte $O(\\log n)$ et on fait $O(n + p)$ opérations au total."
    },
    {
      ...
      correct: 1,
      explanation: "Bellman-Ford effectue $n-1$ passes, chacune examinant toutes les $p$ arêtes, soit $O(n \\cdot p)$."
    },
    {
      ...
      correct: 1,
      explanation: "Floyd-Warshall calcule les distances entre toutes les paires de sommets en O(n³)."
    },
    {
      ...
      correct: 2,
      explanation: "Floyd-Warshall utilise trois boucles imbriquées sur les $n$ sommets, d'où $O(n^3)$."
    },
    {
      ...
      correct: 1,
      explanation: "Dijkstra suppose qu'une fois un sommet extrait du tas, sa distance est définitive. Un poids négatif pourrait la réduire plus tard."
    },
    {
      question: "Pour détecter un cycle de poids négatif avec Bellman-Ford, on effectue :",
      answers: [
      ...
      correct: 1,
      explanation: "Si une n-ième passe modifie encore une distance, c'est qu'il existe un cycle de poids négatif."
    },
    {
      ...
      correct: 1,
      explanation: "La relaxation met à jour la distance estimée de $v$ si passer par $u$ donne un chemin plus court."
    },
    {
      question: "L'algorithme de Johnson pour les plus courts chemins entre toutes paires utilise :",
      answers: [
        "Uniquement Dijkstra",
      ...
      correct: 2,
      explanation: "Johnson utilise Bellman-Ford pour calculer une fonction de potentiel, puis repondère les arêtes pour avoir des poids positifs et applique Dijkstra depuis chaque sommet."
    }
  ]}
/>
