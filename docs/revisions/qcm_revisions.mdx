  ...
  questions={[
    ...
    },
    {
      question: [
        ...
        "+---+---+-----+-----+",
        "| 3 | 4 | &a  | &b  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 1</td><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 4 | 2 | &a  | &a  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 2</td></tr><tr><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 1 | 4 | &a  | &b  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 3</td><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 4 | 2 | &b  | &a  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 4</td></tr></table>",
      ].join("\n"),
      answers: [
        "Schéma 1",
        "Schéma 2",
    ...
    },
    {
      question:
        [
          ...
          "m[2][3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 1</td><td>",
          "```c",
          ...
          "m[2][3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 2</td></tr><tr><td>",
          "```c",
          "int m[12];",
          "m[2*4 + 3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 3</td><td>",
          "```c",
          "int* m = malloc(12 * sizeof(int));",
          "m[2*4 + 3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 4</td></tr></table>"
        ].join("\n"),
      answers: [
        "Possibilité 1",
        "Possibilité 2",
