    ...
    },
    {
      question:
        ["On ouvre le dossier `projet` dans un terminal :",
          "<div class=\"qcm-code-grid\" style=\"display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:12px;\"><div class=\"qcm-code-card\"><pre><code>projet/\n├── include/\n│   └── utils.h\n└── src/\n    ├── main.c\n    └── utils.c</code></pre><p>Fichiers</p></div><div class=\"qcm-code-card\"><pre class=\"language-c\"><code class=\"language-c\">// utils.h\n#ifndef UTILS_H\n#define UTILS_H\n...\n#endif</code></pre><p>utils.h</p></div><div class=\"qcm-code-card\"><pre class=\"language-c\"><code class=\"language-c\">// utils.c\n#include \"../include/utils.h\"\n...</code></pre><p>utils.c</p></div><div class=\"qcm-code-card\"><pre class=\"language-c\"><code class=\"language-c\">// main.c\n#include \"../include/utils.h\"\nint main() { ... }</code></pre><p>main.c</p></div></div>",
          ].join("\n"),
          answers: [
