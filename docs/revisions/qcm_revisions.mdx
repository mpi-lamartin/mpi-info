  ...
  questions={[
    {
      ...
      correct: [0, 4],
      explanation: [
        "Le milieu de $[g, d]$ est `m = (g + d) / 2`.",
        "Si `e < T[m]`, alors `e` est dans la partie gauche, donc on met à jour `d = m - 1`.",
        "Avec `d = m`, on peut avoir une boucle infinie (ex : `g = 0`, `d = 1`, alors `m = 0`, on met `d = m = 0`, puis `m = 0` à nouveau...).",
      ].join("\n"),
    },
    {
      question: [
    ...
    },
    {
      ...
      answers: [
        ...
        "Une formule n'utilisant pas $\\rightarrow$",
      ...
      explanation:
        [
          ...
          "En utilisant les équivalences $\\varphi \\rightarrow \\psi \\equiv \\lnot \\varphi \\lor \\psi$ et $\\lnot(\\varphi_1 \\land \\varphi_2) \\equiv \\lnot \\varphi_1 \\lor \\lnot \\varphi_2$, on peut éliminer les connecteurs $\\rightarrow$ et $\\lor$ pour n'avoir que $\\land$ et $\\lnot$.",
        ].join("\n"),
    },
    {
      question:
