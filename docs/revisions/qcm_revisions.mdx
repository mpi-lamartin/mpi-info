  ...
  questions={[
    {
      question: [
        ...
        "+---+---+-----+-----+",
        "| 3 | 4 | &a  | &b  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 1</p></td><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 4 | 2 | &a  | &a  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 2</p></td></tr><tr><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 1 | 4 | &a  | &b  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 3</p></td><td><pre>+---+---+-----+-----+",
        "| a | b |  p  |  q  |",
        "+---+---+-----+-----+",
        "| 4 | 2 | &b  | &a  |",
        "+---+---+-----+-----+</pre><p align=\"center\">Schéma 4</p></td></tr></table>",
      ].join("\n"),
      answers: [
        "Schéma 1",
        "Schéma 2",
    ...
    },
    {
      ...
      answers: [
        "DCOUPLAGE peut-être défini par :\n```\nEntrée : un graphe biparti $G$ et un entier $k$\nSortie : est-ce que $G$ admet un couplage de cardinal inférieur à $k$ ?\n```",
        "DCOUPLAGE peut-être défini par :\n```\nEntrée : un graphe biparti $G$ et un entier $k$\nSortie : est-ce que $G$ admet un couplage de cardinal égal à $k$ ?\n```",
        "DCOUPLAGE peut-être défini par :\n```\nEntrée : un graphe biparti $G$ et un entier $k$\nSortie : est-ce que $G$ admet un couplage de cardinal supérieur à $k$ ?\n```",
        "DCOUPLAGE $\\in$ P",
        "DCOUPLAGE $\\in$ NP",
    ...
    {
      question: "Si $f$ est une fonction de réduction polynomiale de $\\Pi_1 = (I_1, S_1)$ ($I_1$ : instances, $S_1$ : solutions) à $\\Pi_2 = (I_2, S_2)$ :",
      answers: [
        ...
        "$x \\in S_1 \\Longrightarrow f(x) \\in S_2$",
        "$x \\in S_1 \\Longleftrightarrow f(x) \\in S_2$",
      ],
      correct: [0, 2, 5],
      explanation: "Une fonction de réduction polynomiale de $\\Pi_1$ à $\\Pi_2$ est une fonction $f : I_1 \\longrightarrow I_2$ telle que $f(x)$ est calculable en temps polynomial en fonction de la taille de $x$, et que $x \\in S_1$ si et seulement si $f(x) \\in S_2$.",
    },
    {
      question:
        [
          ...
          "m[2][3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 1</p></td><td>",
          "```c",
          ...
          "m[2][3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 2</p></td></tr><tr><td>",
          "```c",
          "int m[12];",
          "m[2*4 + 3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 3</p></td><td>",
          "```c",
          "int* m = malloc(12 * sizeof(int));",
          "m[2*4 + 3] = 5;",
          "```",
          "<p align=\"center\">Possibilité 4</p></td></tr></table>"
        ].join("\n"),
      answers: [
        "Possibilité 1",
        "Possibilité 2",
