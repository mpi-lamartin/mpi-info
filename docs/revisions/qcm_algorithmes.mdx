...
<QCMRandom
  ...
  questions={[
    ...
    },
    {
      ...
      answers: [
        "Dijkstra, A*, tri par tas, Huffman",
        "BFS, Kosaraju, Floyd-Warshall",
        "Kruskal, Bellman-Ford, DFS",
        "Peterson, Lamport, KNN"
      ],
      correct: 0,
    ...
    },
    {
      ...
      answers: [
        "Floyd-Warshall, exponentiation de matrice",
        "BFS, DFS, Dijkstra",
        "Kruskal, Kosaraju",
        "KNN, K-moyennes"
      ],
    ...
    },
    {
      ...
      answers: [
        "DFS, BFS, Dijkstra, Bellman-Ford, Kosaraju",
        "Floyd-Warshall, exponentiation de matrice",
        "K-moyennes, KNN",
        "Peterson, Lamport"
      ],
