...
0. [Télécharger dnat.ml](./dnat.ml) qui définit les types ci-dessous et écrire une fonction utilitaire `seq : formule list -> formule -> sequent` renvoyant un séquent $\Gamma\vdash\phi$ à partir de $\Gamma$ et $\phi$. 
