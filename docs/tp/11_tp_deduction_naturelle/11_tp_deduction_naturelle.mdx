...
Nous utiliserons les types suivants pour une formule et un séquent $\Gamma \vdash \varphi$ :
...
Pour entrer une formule, on pourra utiliser le [fichier parser.ml à télécharger](./parser.ml) :

```ocaml
#use "parser.ml" (* après la définition des types, et en utilisant le chemin complet *)
...
10. Quand vous avez fini, entraînez-vous sur [https://fortierq.github.io/deduction-naturelle](https://fortierq.github.io/deduction-naturelle).
