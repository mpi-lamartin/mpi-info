...
>
  <img src={require("./rules/axiom.png").default} alt="axiom" />
  <img src={require("./rules/imp_intro.png").default} alt="imp_intro" />
  <img src={require("./rules/imp_elim.png").default} alt="imp_elim" />
  <img src={require("./rules/and_intro.png").default} alt="and_intro" />
  <img src={require("./rules/and_elim_left.png").default} alt="and_elim_left" />
  <img
    src={require("./rules/and_elim_right.png").default}
    alt="and_elim_right"
  />
  <img src={require("./rules/or_intro_left.png").default} alt="or_intro_left" />
  <img
    src={require("./rules/or_intro_right.png").default}
    alt="or_intro_right"
  />
  <img src={require("./rules/or_elim.png").default} alt="or_elim" />
  <img src={require("./rules/neg_elim.png").default} alt="neg_elim" />
  <img src={require("./rules/neg_intro.png").default} alt="neg_intro" />
</div>
