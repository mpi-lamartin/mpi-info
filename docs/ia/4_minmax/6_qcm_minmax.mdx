...
<QCM
  ...
  questions={[
    ...
    {
      question:
        "Dans l'algorithme min-max, le joueur 0 (maximisant) choisit le coup qui :",
      answers: [
        "Minimise la valeur parmi les successeurs",
        "Maximise la valeur parmi les successeurs",
        "Choisit aléatoirement",
        "Choisit le premier successeur",
      ],
      correct: 1,
      explanation:
        "Le joueur 0 cherche à maximiser l'heuristique, il choisit donc le successeur ayant la valeur la plus élevée. Le joueur 1 fait l'inverse (minimise).",
    },
    {
      question:
    ...
    {
      question: "Pour le jeu du domineering, une heuristique raisonnable est :",
      answers: [
        "Le nombre total de cases du plateau",
        "Le nombre de coups possibles pour le joueur 0 moins le nombre de coups possibles pour le joueur 1",
        "Le numéro du tour actuel",
        "La taille du plateau",
      ],
      correct: 1,
      explanation:
        "Une bonne heuristique mesure la mobilité relative : le nombre de coups possibles pour le joueur 0 (vertical) moins le nombre de coups possibles pour le joueur 1 (horizontal). Plus cette valeur est grande, plus la position est favorable au joueur 0.",
    },
    {
      question:
